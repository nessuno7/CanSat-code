...
//only changes made were SD_CS pin = 10 (line 27), const int SPI_CS = 7 (line 28), and remove #include "memorysaver.h" (line 22)
...
//loop function run continuosly
void loop(){
  myCAMSaveToSDFile();
  delay(5000); //change delay for more/less photos
}
